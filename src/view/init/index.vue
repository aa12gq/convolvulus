<template>
  ...
  >
    ...
    >
      <div
        class="oblique h-[130%] w-3/5 bg-white transform -rotate-12 absolute -ml-80"
      />
      <div
        v-if="!page.showForm"
      ...
      >
        <div class="text-lg">
          <div class="font-sans text-4xl font-bold text-center mb-4">
            号仙筛号系统
          </div>
          ...
          <p class="text-gray-600 mb-2">
            2.请您确认是否已经阅读过<a
              ...
              >官方文档</a
            >
            <a class="text-blue-600 font-bold" target="_blank">初始化视频</a>
          </p>
